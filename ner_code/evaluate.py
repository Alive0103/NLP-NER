...
from utils import IEDataset, logger, tqdm, IEDatasetFake
...
comput_kl = model.forward(comput_kl=True)
    ...
    for epoch in epoch_iterator:
        ...
        for batch in train_data_iterator:
            ...
            outputs = model(input_ids=input_ids,
                            ...
                            attention_mask=att_mask,start_positions=start_ids,end_positions=end_ids,comput_kl=True)
...
def KFoldCrossValidator(comput_kl,train_path,save_direction,kl_model_path):
    """
    10 折交叉验证
    """
...
if __name__ == "__main__":
    ...
    KFoldCrossValidator()
    # k=1
    # # KFoldCrossValidator(False,f"data/trains{k}.txt",f"models/model{k}",None)
